...
stackbarchart_df = stackbarchart_df.groupby(['Country']).agg({'Confirmed': 'sum', 'Deaths': 'sum', 'Recovered': 'sum',
...
app.layout = html.Div(children=[
    ...
    html.Div(
        'This stack bar chart represent the CoronaVirus deathes, recovered and under treatment of all reported first 20 countries except China.'),
    dcc.Graph(id='graph3',
              figure={
